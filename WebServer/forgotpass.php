<?php include("header.php"); ?>
 <form action="" method="post" name="UserfpForm" >
  ...
  if($k==0)
  {
  printf("<script>alert('The detail you entered does not belong to any account. Make sure that it is typed correctly. You may also try again using any email or username number associated with your account.')</script>");
   }
