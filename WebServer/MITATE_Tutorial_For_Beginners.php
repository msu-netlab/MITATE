<?php include('header.php'); ?>
	...
	20. If you want to get the per packet network metrics for your experiment, which includes per packet throughput and latency, go to the <a href="http://mitate.cs.montana.edu/mitate_downloads.php" target="_blank">downloads</a> page and download <i>Per Packet Network Metrics.zip</i>. Unzip this file, open MITATE_Per_Packet_Network_Metrics.java and replace the default database username and password with the one you have on your MySQL.<br /><br />
	21. Go to <b>MITATE_Per_Packet_Network_Metrics</b> folder.<br /><br />
	22. Run, <b>javac MITATE_Per_Packet_Network_Metrics.java</b> from your command line terminal.<br /><br />
	23. Run, <b>java MITATE_Per_Packet_Network_Metrics</b>. This will populate the table <i>packetmetrics</i> in your local database.<br /><br />
	
	<h3>Step 4: Querying local database</h3>
	24. To query data for TCP Uplink Throughput, go to the <a href="http://mitate.cs.montana.edu/mitate_downloads.php" target="_blank">downloads</a> page and download the SQL file for <i>TCP Uplink Throughput</i> and run <b> mysql -u m_user -p m_schema < tcp_uplink_throughput.sql	</b><br /><br />
	25. To query data for minimum, mean, and maximum TCP Uplink Latency, go to the <a href="http://mitate.cs.montana.edu/mitate_downloads.php" target="_blank">downloads</a> page and download the SQL file for <i>TCP Uplink Latency</i> and run <b> mysql -u m_user -p m_schema < tcp_uplink_latency.sql	</b><br /><br />
	26. To query data for TCP Uplink Jitter, go to the <a href="http://mitate.cs.montana.edu/mitate_downloads.php" target="_blank">downloads</a> page and download the SQL file for <i>TCP Uplink Jitter</i> and run <b> mysql -u m_user -p m_schema < tcp_uplink_jitter.sql	</b><br /><br />
	27. To query data for TCP Uplink Packet Loss, go to the <a href="http://mitate.cs.montana.edu/mitate_downloads.php" target="_blank">downloads</a> page and download the SQL file for <i>TCP Uplink Packet Loss</i> and run <b> mysql -u m_user -p m_schema < tcp_uplink_packet_loss.sql	</b><br /><br />
	28. To query data for Device Travel Speed in (Km/hr), Device Signal Strength, go to the <a href="http://mitate.cs.montana.edu/mitate_downloads.php" target="_blank">downloads</a> page and download the SQL file for <i>Device Metrics</i> and run <b> mysql -u m_user -p m_schema < device_metric.sql	</b><br /><br />
	29. To query data like the unique deviceid, the network carrier name, and the model name, for the mobile device that executed your experiment, go to the <a href="http://mitate.cs.montana.edu/mitate_downloads.php" target="_blank">downloads</a> page and download the SQL file for <i>Device Details</i> and run <b> mysql -u m_user -p m_schema < device_detail.sql	</b><br /><br />
	</div>
