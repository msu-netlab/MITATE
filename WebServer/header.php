...
<div style="top:20px;margin-left:auto;margin-right:auto;max-width:1000px;height:auto;">
    ...
    <div style="background-color:white;height:auto;font-size: 18px;text-align: center;"><a href="index.php"
        ...
        <?php if (!isset($_SESSION['mitateLoggedInUser'])) { ?> | <a href="mitate_signup.php"
                                                                     style="text-decoration:none;">Signup</a>    <?php } ?>

        | <a href="mitate_downloads.php"
             style="text-decoration:none;">Downloads</a> <?php if (isset($_SESSION['mitateLoggedInUser'])) { ?>
            | <a style="text-decoration:none;" href="settings.php">Settings</a> | <a style="text-decoration:none;"
                                                                                     href="mitate_logout.php">Logout</a> |
            <a href="mitate_publications.php" style="text-decoration:none;">Publications</a> | <a
                    style="text-decoration:none;" href="mitate_team.php">People</a>
        <?php } ?>
    </div>
    <hr/>