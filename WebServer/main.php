...
if($_FILES["file"]["name"] != "")
{
	...
	else
	{
		...
		mkdir("user_accounts/$_COOKIE[username]/$experiment_id", 0777);
		move_uploaded_file($_FILES["file"]["tmp_name"],"user_accounts/" . $_COOKIE["username"] . "/$experiment_id/" . $final_file_path);		
		$yesdone = 1;
	}
}
